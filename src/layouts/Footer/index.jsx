  ...
  return (
    <footer className="footer">
      <div className="content relative max-w-full px-6">
        ...
        <div className="flex flex-wrap gap-x-2 gap-y-8 mx-auto">
          <ul className="max-w-lg px-4">
            <h3 className="text-xl mb-5">Sede administrativa e Casa de acolhimento</h3>
          ...
          <ul className="max-w-lg px-3">
            <h3 className="text-xl mb-5">Galpão de reciclagem</h3>
